-- ═══════════════════════════════════════════════════════════════════
--  NetsDial – PAN India Expansion SQL
--  Adds all major cities of India as districts with their key areas
--  Total: ~75 new districts, ~750 new areas → 19,000+ service pages
-- ═══════════════════════════════════════════════════════════════════

-- ── ANDHRA PRADESH (additional cities) ──────────────────────────────
INSERT IGNORE INTO districts (name,slug,state,is_active) VALUES
('Kurnool',       'kurnool',       'Andhra Pradesh', 1),
('Nellore',       'nellore',       'Andhra Pradesh', 1),
('Kadapa',        'kadapa',        'Andhra Pradesh', 1),
('Anantapur',     'anantapur',     'Andhra Pradesh', 1),
('Chittoor',      'chittoor',      'Andhra Pradesh', 1),
('Eluru',         'eluru',         'Andhra Pradesh', 1),
('Kakinada',      'kakinada',      'Andhra Pradesh', 1),
('Ongole',        'ongole',        'Andhra Pradesh', 1);

-- ── KARNATAKA ────────────────────────────────────────────────────────
INSERT IGNORE INTO districts (name,slug,state,is_active) VALUES
('Bengaluru',     'bengaluru',     'Karnataka', 1),
('Mysuru',        'mysuru',        'Karnataka', 1),
('Hubli-Dharwad', 'hubli-dharwad', 'Karnataka', 1),
('Mangaluru',     'mangaluru',     'Karnataka', 1),
('Belagavi',      'belagavi',      'Karnataka', 1),
('Kalaburagi',    'kalaburagi',    'Karnataka', 1),
('Tumakuru',      'tumakuru',      'Karnataka', 1),
('Shivamogga',    'shivamogga',    'Karnataka', 1);
...
('Tiruchirappalli','tiruchirappalli','Tamil Nadu', 1),
('Salem',         'salem',         'Tamil Nadu', 1),
('Tirunelveli',   'tirunelveli',   'Tamil Nadu', 1),
('Erode',         'erode',         'Tamil Nadu', 1),
('Vellore',       'vellore',       'Tamil Nadu', 1),
('Thoothukudi',   'thoothukudi',   'Tamil Nadu', 1);

-- ── KERALA ───────────────────────────────────────────────────────────
INSERT IGNORE INTO districts (name,slug,state,is_active) VALUES
('Kochi',         'kochi',         'Kerala', 1),
('Thiruvananthapuram','thiruvananthapuram','Kerala', 1),
('Kozhikode',     'kozhikode',     'Kerala', 1),
('Thrissur',      'thrissur',      'Kerala', 1),
('Kollam',        'kollam',        'Kerala', 1),
('Malappuram',    'malappuram',    'Kerala', 1),
('Kannur',        'kannur',        'Kerala', 1),
('Palakkad',      'palakkad',      'Kerala', 1);

-- ── MAHARASHTRA ─────────────────────────────────────────────────────
INSERT IGNORE INTO districts (name,slug,state,is_active) VALUES
('Mumbai',        'mumbai',        'Maharashtra', 1),
('Pune',          'pune',          'Maharashtra', 1),
('Nagpur',        'nagpur',        'Maharashtra', 1),
('Nashik',        'nashik',        'Maharashtra', 1),
('Aurangabad',    'aurangabad',    'Maharashtra', 1),
('Solapur',       'solapur',       'Maharashtra', 1),
('Thane',         'thane',         'Maharashtra', 1),
('Kolhapur',      'kolhapur',      'Maharashtra', 1),
('Navi Mumbai',   'navi-mumbai',   'Maharashtra', 1),
('Vasai-Virar',   'vasai-virar',   'Maharashtra', 1);

-- ── DELHI NCR ────────────────────────────────────────────────────────
INSERT IGNORE INTO districts (name,slug,state,is_active) VALUES
('Delhi',         'delhi',         'Delhi', 1),
('Noida',         'noida',         'Uttar Pradesh', 1),
('Gurgaon',       'gurgaon',       'Haryana', 1),
('Faridabad',     'faridabad',     'Haryana', 1),
('Ghaziabad',     'ghaziabad',     'Uttar Pradesh', 1),
('Greater Noida', 'greater-noida', 'Uttar Pradesh', 1);

-- ── UTTAR PRADESH ────────────────────────────────────────────────────
INSERT IGNORE INTO districts (name,slug,state,is_active) VALUES
('Lucknow',       'lucknow',       'Uttar Pradesh', 1),
('Kanpur',        'kanpur',        'Uttar Pradesh', 1),
('Agra',          'agra',          'Uttar Pradesh', 1),
('Varanasi',      'varanasi',      'Uttar Pradesh', 1),
('Allahabad',     'allahabad',     'Uttar Pradesh', 1),
('Meerut',        'meerut',        'Uttar Pradesh', 1),
('Bareilly',      'bareilly',      'Uttar Pradesh', 1);

-- ── RAJASTHAN ────────────────────────────────────────────────────────
INSERT IGNORE INTO districts (name,slug,state,is_active) VALUES
('Jaipur',        'jaipur',        'Rajasthan', 1),
('Jodhpur',       'jodhpur',       'Rajasthan', 1),
('Udaipur',       'udaipur',       'Rajasthan', 1),
('Kota',          'kota',          'Rajasthan', 1),
('Ajmer',         'ajmer',         'Rajasthan', 1);

-- ── GUJARAT ──────────────────────────────────────────────────────────
INSERT IGNORE INTO districts (name,slug,state,is_active) VALUES
('Ahmedabad',     'ahmedabad',     'Gujarat', 1),
('Surat',         'surat',         'Gujarat', 1),
('Vadodara',      'vadodara',      'Gujarat', 1),
('Rajkot',        'rajkot',        'Gujarat', 1),
('Gandhinagar',   'gandhinagar',   'Gujarat', 1),
('Bhavnagar',     'bhavnagar',     'Gujarat', 1);

-- ── WEST BENGAL ──────────────────────────────────────────────────────
INSERT IGNORE INTO districts (name,slug,state,is_active) VALUES
('Kolkata',       'kolkata',       'West Bengal', 1),
('Howrah',        'howrah',        'West Bengal', 1),
('Durgapur',      'durgapur',      'West Bengal', 1),
('Asansol',       'asansol',       'West Bengal', 1),
('Siliguri',      'siliguri',      'West Bengal', 1);

-- ── MADHYA PRADESH ───────────────────────────────────────────────────
INSERT IGNORE INTO districts (name,slug,state,is_active) VALUES
('Bhopal',        'bhopal',        'Madhya Pradesh', 1),
('Indore',        'indore',        'Madhya Pradesh', 1),
('Gwalior',       'gwalior',       'Madhya Pradesh', 1),
('Jabalpur',      'jabalpur',      'Madhya Pradesh', 1),
('Ujjain',        'ujjain',        'Madhya Pradesh', 1);

-- ── PUNJAB & HARYANA ─────────────────────────────────────────────────
INSERT IGNORE INTO districts (name,slug,state,is_active) VALUES
('Chandigarh',    'chandigarh',    'Chandigarh', 1),
('Ludhiana',      'ludhiana',      'Punjab', 1),
('Amritsar',      'amritsar',      'Punjab', 1),
('Jalandhar',     'jalandhar',     'Punjab', 1),
('Patiala',       'patiala',       'Punjab', 1),
('Ambala',        'ambala',        'Haryana', 1),
('Rohtak',        'rohtak',        'Haryana', 1),
('Hisar',         'hisar',         'Haryana', 1);

-- ── OTHER MAJOR CITIES ───────────────────────────────────────────────
INSERT IGNORE INTO districts (name,slug,state,is_active) VALUES
('Bhubaneswar',   'bhubaneswar',   'Odisha', 1),
('Cuttack',       'cuttack',       'Odisha', 1),
('Patna',         'patna',         'Bihar', 1),
('Ranchi',        'ranchi',        'Jharkhand', 1),
('Raipur',        'raipur',        'Chhattisgarh', 1),
('Guwahati',      'guwahati',      'Assam', 1),
('Dehradun',      'dehradun',      'Uttarakhand', 1),
('Shimla',        'shimla',        'Himachal Pradesh', 1),
('Jammu',         'jammu',         'Jammu & Kashmir', 1),
('Srinagar',      'srinagar',      'Jammu & Kashmir', 1),
('Puducherry',    'puducherry',    'Puducherry', 1),
('Coorg',         'coorg',         'Karnataka', 1);


-- ══════════════════════════════════════════════════════════════════════
--  AREAS – INSERT FOR EACH NEW CITY
-- ══════════════════════════════════════════════════════════════════════

-- ── ANDHRA PRADESH ADDITIONAL ────────────────────────────────────────
INSERT IGNORE INTO areas (district_id, name, slug, is_active)
SELECT d.id, a.name, a.slug, 1
FROM districts d
JOIN (VALUES
  ROW('Kurnool','Kurnool City'),ROW('Kurnool','Nandyal'),ROW('Kurnool','Adoni'),ROW('Kurnool','Dhone'),ROW('Kurnool','Yemmiganur'),
  ROW('Nellore','Nellore City'),ROW('Nellore','Kavali'),ROW('Nellore','Gudur'),ROW('Nellore','Sullurpeta'),ROW('Nellore','Atmakur'),
  ROW('Kadapa','Kadapa City'),ROW('Kadapa','Proddatur'),ROW('Kadapa','Rajampet'),ROW('Kadapa','Pulivendla'),
  ROW('Anantapur','Anantapur City'),ROW('Anantapur','Guntakal'),ROW('Anantapur','Hindupur'),ROW('Anantapur','Tadipatri'),
  ROW('Chittoor','Chittoor City'),ROW('Chittoor','Tirupati Rural'),ROW('Chittoor','Madanapalle'),ROW('Chittoor','Srikalahasti'),
  ROW('Eluru','Eluru City'),ROW('Eluru','Bhimavaram'),ROW('Eluru','Tadepalligudem'),
  ROW('Kakinada','Kakinada City'),ROW('Kakinada','Pithapuram'),ROW('Kakinada','Amalapuram'),
  ROW('Ongole','Ongole City'),ROW('Ongole','Chirala'),ROW('Ongole','Kandukur')
) AS a(district_name, name) ON d.name = a.district_name AND d.state = 'Andhra Pradesh',
(SELECT LOWER(REPLACE(REPLACE(REPLACE(name,' ','-'),'.',''),',','')) as slug FROM (VALUES ROW('placeholder')) as x(name)) x
WHERE 1=0; -- placeholder, using separate inserts below

-- ANDHRA PRADESH ADDITIONAL areas
...
(@bengaluru,'Begur Road','begur-road',1),(@bengaluru,'Uttarahalli','uttarahalli',1),(@bengaluru,'Bellandur','bellandur',1),
(@bengaluru,'Kudlu Gate','kudlu-gate',1),(@bengaluru,'Singasandra','singasandra',1),(@bengaluru,'Hulimavu','hulimavu',1),
(@bengaluru,'Kengeri','kengeri',1),(@bengaluru,'Vijayanagar','vijayanagar-bengaluru',1),(@bengaluru,'Basavanagudi','basavanagudi',1),
(@bengaluru,'Wilson Garden','wilson-garden',1),(@bengaluru,'Frazer Town','frazer-town',1),(@bengaluru,'RT Nagar','rt-nagar',1),
(@bengaluru,'Sahakara Nagar','sahakara-nagar',1),(@bengaluru,'Banaswadi','banaswadi',1),(@bengaluru,'CV Raman Nagar','cv-raman-nagar',1),
(@bengaluru,'Devanahalli','devanahalli',1),(@bengaluru,'Nelamangala','nelamangala',1),
-- Mysuru (10 areas)
(@mysuru,'Mysuru City','mysuru-city',1),(@mysuru,'Jayanagar Mysuru','jayanagar-mysuru',1),(@mysuru,'Vijayanagar Mysuru','vijayanagar-mysuru',1),
(@mysuru,'Kuvempunagar','kuvempunagar',1),(@mysuru,'Hebbal Mysuru','hebbal-mysuru',1),(@mysuru,'Nazarbad','nazarbad',1),
(@mysuru,'Gokulam','gokulam',1),(@mysuru,'Saraswathipuram','saraswathipuram',1),(@mysuru,'Bogadi','bogadi',1),(@mysuru,'Rajiv Nagar','rajiv-nagar-mysuru',1),
-- Other Karnataka
(@hubli,'Hubli','hubli',1),(@hubli,'Dharwad','dharwad',1),(@hubli,'Gokul Road','gokul-road',1),(@hubli,'Vidyanagar','vidyanagar',1),
...
(@belagavi,'Belagavi City','belagavi-city',1),(@belagavi,'Tilakwadi','tilakwadi',1),(@belagavi,'Nehru Nagar','nehru-nagar',1),
...
(@chennai,'Medavakkam','medavakkam',1),(@chennai,'Selaiyur','selaiyur',1),(@chennai,'Nanganallur','nanganallur',1),
(@chennai,'Alandur','alandur',1),(@chennai,'Saidapet','saidapet',1),(@chennai,'Kodambakkam','kodambakkam',1),
(@chennai,'Vadapalani','vadapalani',1),(@chennai,'Koyambedu','koyambedu',1),(@chennai,'Nerkundram','nerkundram',1),
-- Coimbatore (10 areas)
(@coimbatore,'RS Puram','rs-puram',1),(@coimbatore,'Gandhipuram','gandhipuram',1),(@coimbatore,'Peelamedu','peelamedu',1),
(@coimbatore,'Saibaba Colony','saibaba-colony',1),(@coimbatore,'Singanallur','singanallur',1),(@coimbatore,'Ramnagar','ramnagar-coimbatore',1),
(@coimbatore,'Uppilipalayam','uppilipalayam',1),(@coimbatore,'Sowripalayam','sowripalayam',1),(@coimbatore,'Hopes College','hopes-college',1),(@coimbatore,'Podanur','podanur',1),
-- Madurai (8 areas)
(@madurai,'Mattuthavani','mattuthavani',1),(@madurai,'Bypass Road','bypass-road-madurai',1),(@madurai,'Anna Nagar Madurai','anna-nagar-madurai',1),
...
(@thoothukudi,'Thoothukudi City','thoothukudi-city',1),(@thoothukudi,'Palayamkottai','palayamkottai-thoothukudi',1);
...
INSERT IGNORE INTO areas (district_id,name,slug,is_active) VALUES
(@kochi,'Kakkanad','kakkanad',1),(@kochi,'Edappally','edappally',1),(@kochi,'Aluva','aluva',1),(@kochi,'Tripunithura','tripunithura',1),(@kochi,'Thripunithura','thripunithura',1),
(@kochi,'Vyttila','vyttila',1),(@kochi,'Palarivattom','palarivattom',1),(@kochi,'Kaloor','kaloor',1),(@kochi,'Fort Kochi','fort-kochi',1),(@kochi,'Maradu','maradu',1),
(@tvm,'Kowdiar','kowdiar',1),(@tvm,'Pattom','pattom',1),(@tvm,'Kazhakkoottam','kazhakkoottam',1),(@tvm,'Technopark','technopark',1),(@tvm,'Vanchiyoor','vanchiyoor',1),
(@tvm,'Kesavadasapuram','kesavadasapuram',1),(@tvm,'Sreekaryam','sreekaryam',1),(@tvm,'Nalanchira','nalanchira',1),
(@kozhikode,'Calicut City','calicut-city',1),(@kozhikode,'Mavoor Road','mavoor-road',1),(@kozhikode,'Nadakkavu','nadakkavu',1),(@kozhikode,'Westhill','westhill',1),(@kozhikode,'Palayam','palayam-kozhikode',1),
...
(@pune,'Kothrud','kothrud',1),(@pune,'Deccan','deccan',1),(@pune,'Shivajinagar','shivajinagar-pune',1),(@pune,'Camp','camp-pune',1),
...
(@pune,'Dhayari','dhayari',1),(@pune,'Bavdhan','bavdhan',1),(@pune,'Pimple Saudagar','pimple-saudagar',1),(@pune,'Sangvi','sangvi',1),
-- Nagpur (8 areas)
(@nagpur,'Civil Lines','civil-lines-nagpur',1),(@nagpur,'Dharampeth','dharampeth',1),(@nagpur,'Sitabuldi','sitabuldi',1),(@nagpur,'Sadar','sadar',1),
...
-- Other Maharashtra
(@nashik,'Nashik Road','nashik-road',1),(@nashik,'Cidco','cidco-nashik',1),(@nashik,'Gangapur Road','gangapur-road',1),(@nashik,'Ambad','ambad',1),(@nashik,'Panchavati','panchavati',1),
...
(@delhi,'Saket','saket',1),(@delhi,'Malviya Nagar','malviya-nagar',1),(@delhi,'Kalkaji','kalkaji',1),(@delhi,'Nehru Place','nehru-place',1),
...
(@noida,'Sector 18','sector-18-noida',1),(@noida,'Sector 62','sector-62-noida',1),(@noida,'Sector 76','sector-76-noida',1),(@noida,'Sector 137','sector-137-noida',1),(@noida,'Sector 150','sector-150-noida',1),
(@gurgaon,'DLF Phase 1','dlf-phase-1',1),(@gurgaon,'Sushant Lok','sushant-lok',1),(@gurgaon,'Sector 56','sector-56-gurgaon',1),(@gurgaon,'Golf Course Road','golf-course-road',1),(@gurgaon,'MG Road','mg-road-gurgaon',1),
(@faridabad,'Sector 14','sector-14-faridabad',1),(@faridabad,'NIT','nit-faridabad',1),(@faridabad,'Ballabgarh','ballabgarh',1),
...
INSERT IGNORE INTO areas (district_id,name,slug,is_active) VALUES
(@lucknow,'Gomti Nagar','gomti-nagar',1),(@lucknow,'Hazratganj','hazratganj',1),(@lucknow,'Aliganj','aliganj',1),(@lucknow,'Indira Nagar','indira-nagar-lucknow',1),(@lucknow,'Alambagh','alambagh',1),
(@lucknow,'Vikas Nagar','vikas-nagar-lucknow',1),(@lucknow,'Mahanagar','mahanagar',1),(@lucknow,'Rajajipuram','rajajipuram',1),
(@kanpur,'Civil Lines','civil-lines-kanpur',1),(@kanpur,'Kidwai Nagar','kidwai-nagar',1),(@kanpur,'Kakadeo','kakadeo',1),(@kanpur,'Swaroop Nagar','swaroop-nagar',1),(@kanpur,'Govind Nagar','govind-nagar',1),
(@agra,'Taj Ganj','taj-ganj',1),(@agra,'Fatehabad Road','fatehabad-road',1),(@agra,'Sikandra','sikandra',1),(@agra,'Kamla Nagar','kamla-nagar-agra',1),
(@varanasi,'Lanka','lanka',1),(@varanasi,'Sigra','sigra',1),(@varanasi,'Cantonment','cantonment-varanasi',1),(@varanasi,'Shivpur','shivpur',1),
(@allahabad,'Civil Lines','civil-lines-allahabad',1),(@allahabad,'George Town','george-town',1),(@allahabad,'Naini','naini',1),
(@meerut,'Shastri Nagar','shastri-nagar-meerut',1),(@meerut,'Pallavpuram','pallavpuram',1),(@meerut,'Garh Road','garh-road',1),
(@bareilly,'Civil Lines','civil-lines-bareilly',1),(@bareilly,'Pilibhit Road','pilibhit-road',1);
...
INSERT IGNORE INTO areas (district_id,name,slug,is_active) VALUES
(@jaipur,'Vaishali Nagar','vaishali-nagar-jaipur',1),(@jaipur,'Malviya Nagar','malviya-nagar-jaipur',1),(@jaipur,'C Scheme','c-scheme',1),(@jaipur,'Mansarovar','mansarovar',1),
(@jaipur,'Tonk Road','tonk-road',1),(@jaipur,'Sanganer','sanganer',1),(@jaipur,'Sitapura','sitapura',1),(@jaipur,'Bajaj Nagar','bajaj-nagar',1),
(@jodhpur,'Sardarpura','sardarpura',1),(@jodhpur,'Pratap Nagar','pratap-nagar-jodhpur',1),(@jodhpur,'Ratanada','ratanada',1),(@jodhpur,'Shastri Nagar','shastri-nagar-jodhpur',1),
...
(@ajmer,'Vaishali Nagar','vaishali-nagar-ajmer',1),(@ajmer,'Madar','madar',1);
...
(@surat,'Adajan','adajan',1),(@surat,'Vesu','vesu',1),(@surat,'Pal','pal-surat',1),(@surat,'Dumas Road','dumas-road',1),(@surat,'Katargam','katargam',1),(@surat,'Udhna','udhna',1),
...
(@gandhinagar,'Sector 7','sector-7-gandhinagar',1),(@gandhinagar,'Sector 21','sector-21-gandhinagar',1),
...
INSERT IGNORE INTO areas (district_id,name,slug,is_active) VALUES
(@kolkata,'Salt Lake','salt-lake',1),(@kolkata,'New Town','new-town-kolkata',1),(@kolkata,'Ballygunge','ballygunge',1),(@kolkata,'Park Street','park-street',1),
...
(@durgapur,'City Centre','city-centre-durgapur',1),(@durgapur,'Bidhannagar','bidhannagar-durgapur',1),
...
(@indore,'Vijay Nagar','vijay-nagar-indore',1),(@indore,'Palasia','palasia',1),(@indore,'Bhawarkua','bhawarkua',1),(@indore,'Rau','rau',1),(@indore,'AB Road','ab-road',1),
(@gwalior,'City Centre','city-centre-gwalior',1),(@gwalior,'Lashkar','lashkar',1),(@gwalior,'Morar','morar',1),
(@jabalpur,'Napier Town','napier-town',1),(@jabalpur,'Vijay Nagar','vijay-nagar-jabalpur',1),(@jabalpur,'Gwarighat','gwarighat',1),
...
INSERT IGNORE INTO areas (district_id,name,slug,is_active) VALUES
(@chandigarh,'Sector 17','sector-17-chandigarh',1),(@chandigarh,'Sector 22','sector-22-chandigarh',1),(@chandigarh,'Sector 35','sector-35-chandigarh',1),(@chandigarh,'Manimajra','manimajra',1),
(@ludhiana,'Model Town','model-town-ludhiana',1),(@ludhiana,'Civil Lines','civil-lines-ludhiana',1),(@ludhiana,'Sarabha Nagar','sarabha-nagar',1),
(@amritsar,'Lawrence Road','lawrence-road',1),(@amritsar,'Ranjit Avenue','ranjit-avenue',1),(@amritsar,'GT Road','gt-road-amritsar',1),
(@jalandhar,'Model Town','model-town-jalandhar',1),(@jalandhar,'Civil Lines','civil-lines-jalandhar',1),(@jalandhar,'Lajpat Nagar','lajpat-nagar-jalandhar',1),
(@patiala,'Civil Lines','civil-lines-patiala',1),(@patiala,'Model Town','model-town-patiala',1),
(@ambala,'Ambala City','ambala-city',1),(@ambala,'Ambala Cantonment','ambala-cantonment',1),
(@rohtak,'Delhi Road','delhi-road-rohtak',1),(@rohtak,'Asthal Bohar','asthal-bohar',1),
(@hisar,'Urban Estate','urban-estate-hisar',1),(@hisar,'Hansi Road','hansi-road',1);
...
(@raipur,'Shankar Nagar','shankar-nagar-raipur',1),(@raipur,'Telibandha','telibandha',1),(@raipur,'Pandri','pandri',1),(@raipur,'Tatibandh','tatibandh',1),
...
(@dehradun,'Rajpur Road','rajpur-road',1),(@dehradun,'Patel Nagar','patel-nagar-dehradun',1),(@dehradun,'Clement Town','clement-town',1),
(@puducherry,'White Town','white-town',1),(@puducherry,'Anna Nagar','anna-nagar-puducherry',1),(@puducherry,'Lawspet','lawspet',1);

-- ── FINAL COUNT VERIFICATION ─────────────────────────────────────────
SELECT 'Districts' as type, COUNT(*) as total FROM districts;
SELECT 'Areas' as type, COUNT(*) as total FROM areas;
SELECT CONCAT(COUNT(*), ' total service pages would be: ', COUNT(*)*19) as service_pages_estimate
FROM areas WHERE is_active=1;
